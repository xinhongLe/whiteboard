<template>
    <div class="triangle-container" ref="triangleRef">
        ...
        >
            <div class="content triangle-move">
                ...
                <div class="triangle-buttons">
                    ...
                    <div class="ruler-button triangle-magnify">
                        <img src="../ruler/images/resize.svg" alt=""/>
                    </div>
                    <div class="ruler-button triangle-rotate">
                        <img src="../ruler/images/rotate.svg" alt=""/>
                    </div>
                    <div class="ruler-button triangle-resize">
                        <img src="../ruler/images/resize.svg" alt=""/>
                    </div>
                </div>
            </div>
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const handleMouseDown = (event: PointerEvent | TouchEvent) => {
            ...
            if (isTriangleArea(event) && className !== "triangle-scale") {
                mode.value = "move";
            }

            if (className === "ruler-button triangle-magnify") {
                mode.value = "magnify";
            }
            if (className === "ruler-button triangle-resize") {
                mode.value = "resize";
            }
            if (className === "ruler-button triangle-rotate") {
                mode.value = "rotate";
                startAngle = getAngle(
            ...
            if (className.includes("triangle-scale")) {
        ...
        onMounted(() => {
            ...
            if (triangleRef.value) {
                x.value = triangleRef.value.clientWidth / 2 - 250;
                y.value = triangleRef.value.clientHeight / 2 - height.value;
            }
